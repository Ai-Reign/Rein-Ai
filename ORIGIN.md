...
What it *did* do was teach me something I didn't expect. Every week I'd find the bot doing something I hadn't imagined. Placing trades on dead-book markets with no counterparty. Holding positions past expiration because the exit manager returned a 400 and kept retrying. Chasing stale signals after the model had drifted. Each time I'd patch it — add a filter, a timeout, a sanity check.
