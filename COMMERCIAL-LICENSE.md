...
If you are an individual, researcher, hobbyist, or open-source project comfortable with AGPL-3.0 — you do **not** need a commercial license. Use the AGPL version freely.

---

## Pricing (indicative — final terms by quote)
...
- Custom adapters and integration assistance
- Security disclosure pre-notification
...
Contributors retain copyright on their contributions and grant the project a license under the project's CLA. Significant contributors may receive credits toward a commercial license — ask.

**Q: Will you ever change the license?**
The version released under AGPL-3.0 stays AGPL-3.0 forever. Future versions may use a different open-source license, but never less permissive than AGPL-3.0 for the OSS track.
